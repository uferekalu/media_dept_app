...
// Dedicated change-password screen — separate from a general profile-edit form, since
// a password change has its own rule (must differ from the current password, enforced
// server-side in AuthService.changePassword()) that a "leave blank to keep it" field
// on a profile form couldn't express cleanly.
