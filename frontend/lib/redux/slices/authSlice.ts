...
export const AUTH_TOKEN_STORAGE_KEY = 'media-department:auth-token';
...
// (the login page and the logout action), same pattern as the old
// sessionSlice/acting-as-picker.tsx it replaces.
interface AuthState {
  token: string | null;
}
