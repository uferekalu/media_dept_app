...
// triggered it (e.g. creating a CrewAssignment). Shares the same Termii account as
// protocol_dept_app — an explicit, confirmed exception to the sibling-apps-independent
// rule (see backend/CLAUDE.md).
@Injectable()
